...
while True:
    ...
    cv2.line(Frame, (0, CoorYEntranceLine), (width, CoorYEntranceLine), (14, 14, 14), 2)
    cv2.line(Frame, (0, CoorYExitLine), (width, CoorYExitLine), (14, 14, 14), 2)
    ...
    for c in cnts:
        ...
        cv2.circle(Frame, ObjectCentroid, 1, (255, 0, 0), 5)
    ...
    cv2.rectangle(Frame, pt1=(0, 0), pt2=(850, 50), color=(0, 0, 0), thickness=-1)
    cv2.putText(Frame, "Entradas: {}".format(str(EntranceCounter)), (10, 30),
